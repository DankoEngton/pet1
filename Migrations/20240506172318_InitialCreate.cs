    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Drugs_Warehouses_WarehouseId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrdersDrugs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OrdersDrugs_Drugs_DrugId",
                        column: x => x.DrugId,
                        principalTable: "Drugs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrdersDrugs_Orders_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Drugs_WarehouseId",
                table: "Drugs",
                column: "WarehouseId");

            migrationBuilder.CreateIndex(
                name: "IX_OrdersDrugs_DrugId",
                table: "OrdersDrugs",
                column: "DrugId");

            migrationBuilder.CreateIndex(
                name: "IX_OrdersDrugs_OrderId",
                table: "OrdersDrugs",
                column: "OrderId");
